...
function matchedID(item){
    if (item === "Original"){
        var original = new createBun("Original Cinnamon Bun", 3.00, "images/original.png", 
    "Our classic original cinnamon bun is a fan favorite. \
    You can never go wrong with the original as it suits almost every taste \
    palette out there.", "sugarmilk", 1, "Original");
        return original;
    } 
    else if (item === "Blackberry"){
        var blackberry = new createBun("Blackberry Bun", 3.75,"images/blackberry.png",
    "Soft from-scratch rolls filled with brown sugar, \
    cinnamon, and fresh blackberries, topped with a glaze of your choice. \
    Our blackberry buns are a summer favorite to start of your day!", 
    "sugarmilk", 1, "Blackberry");
        return blackberry;
    }
    else if (item === "Pumpkin"){
        var pumpkinSpice = new createBun("Pumpkin Spice Bun", 4.00, "images/pumpkin-spice.png",
    "Our pumpkin spice buns are a fall favorite, perfect \
    for a cozy day paired with a warm cup of coffee. The pumpkin spice \
    and flavor make this bun the seasonal favorite that it is.", "sugarmilk", 
    1, "Pumpkin");
        return pumpkinSpice;
    }
    else if (item === "Caramel"){
        var caramelPecan = new createBun("Caramel Pecan Bun", 3.75, "images/caramel-pecan.png",
    "Our caramel pecan bun is filled with ooey gooey caramel \
    goodness with crushed pecans sprinkled on top for the perfect contrast of \
    crunchy and velvety textures! This bun is perfect for when you need a little\
    extra sweetness in your life", "sugarmilk", 1, "Caramel");
        return caramelPecan;
    }
    else if (item === "Walnut"){
        var walnut = new createBun("Walnut Bun", 3.75, "images/walnut.png", 
    "Everybody goes nuts for our walnut bun! \
    Its most popular glaze pairing is our double chocolate glaze\
    as it adds a perfect kick to the nutty flavor of our walnut bun.",
    "sugarmilk", 1, "Walnut");
        return walnut;
    }
    else if (item === "Gluten"){
        var glutenFree = new createBun("Gluten Free Bun", 3.50, "images/gluten-free.png",
    "We aim to make our buns accessible to everyone, \
    and that includes our friends with any dietary restrictions. That's \
    why we chose to create a gluten-free option of our original cinnamon bun.\
    Of course, we have plans to expand and provide more flavors to our gluten-free\
    friends, but we hope you're able eo enjoy your experience with this one for now!",
    "sugarmilk", 1, "Gluten");
        return glutenFree;
    }
}
